...
public class MapsActivity extends ActionBarActivity implements
    ...
    Marker my_marker;
    LatLng my_latlng= new LatLng(-33.4414405,-70.652387);
    ...
    private void setUpMap() {
        ...
        CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLngZoom(
                new LatLng(-33.4414405,-70.652387), 15);
        mMap.animateCamera(cameraUpdate);
        mMap.setOnMyLocationChangeListener(new GoogleMap.OnMyLocationChangeListener() {
            @Override
            public void onMyLocationChange(Location location) {
                my_marker = mMap.addMarker(new MarkerOptions().position(new LatLng(location.getLatitude(),location.getLongitude())).title("Mi posición").icon(BitmapDescriptorFactory.fromResource(pin_yo)));
          }
        });
